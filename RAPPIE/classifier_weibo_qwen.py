...
def main():
    ...
    def batch_loader(data, data_type):
        if not os.path.exists(args.dataset + "_"+'qwen_'+ "_y/" + data_type + "/batch_0.pkl"): # 全部关系
            ...
            for line_id, line in enumerate(data):
                ...
                text_qwenid = int(line[columns["text_qwenid"]]) - 1
                # 用户关系
    ...
    def evaluate(args, is_test):
        if is_test:
            dataset = read_dataset(args.dataset + "/test_y_qwen.txt")[1:]
            data_type = "test"
        else:
            dataset = read_dataset(args.dataset + "/valid_y_qwen.txt")[1:]
            data_type = "evaluate"
    ...
    parser.add_argument("--output_model_path", default="/mnt/newhome/stu3/w_2/other/classifier_model_y.bin", type=str,
                        help="Path of the output model.")
    parser.add_argument("--dataset", default="/mnt/newhome/stu3/w_2/data", type=str,
    ...
    path2 = "dataset/weibo_qwen/user_embedding_retweet_r.pkl"
    path3 = "dataset/weibo_qwen/user_embedding_comment_r.pkl"
    file2 = open(path2, "rb")
    file3 = open(path3, "rb")
    role_file = open("dataset/weibo_qwen/role_features_qwen.pkl", "rb")
    text_file = open("dataset/weibo_qwen/weibi_text_features.pkl", "rb")
    ...
    dataset = read_dataset(args.dataset + "/train_y_en_qwen.txt")
