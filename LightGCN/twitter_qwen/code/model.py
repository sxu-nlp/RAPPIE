...
class LightGCN(BasicModel):
    ...
    def __init_weight(self):
        ...
        # self.embedding_item = torch.nn.Embedding(
        #     num_embeddings=self.num_items, embedding_dim=self.latent_dim)
        self.linear_adapter1 = nn.Linear(5120, 2560)
        self.linear_adapter3 = nn.Linear(5120, 5120)
        self.linear_adapter4 = nn.Linear(5120, 2560)
        self.linear_adapter5 = nn.Linear(5120, 2560)
        self.linear_adapter6 = nn.Linear(5120, 5120)
        self.linear_adapter7 = nn.Linear(5120, 2560)
        self.linear_adapter8 = nn.Linear(5120, 5120)
        self.linear_adapter9 = nn.Linear(4096, 5120)
        self.linear_adapter10 = nn.Linear(5120, 5120)
        self.multi_head_attention1 = torch.nn.MultiheadAttention(5120, 8, dropout=0)
        self.multi_head_attention2 = torch.nn.MultiheadAttention(5120, 8, dropout=0)
        # W2
        user_in_emb_path = "../data/" + world.dataset + "/user_features_yw_qwen.pkl"
        user_a_emb_path = "../data/" + world.dataset + "/yw_user_attitude.pkl"
        ...
        user_embedding_tensor_0 = torch.stack(attention_outputs)  # (3508, 5120)
