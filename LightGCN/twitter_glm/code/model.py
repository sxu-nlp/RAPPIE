...
class LightGCN(BasicModel):
    ...
    def __init_weight(self):
        ...
        self.linear_adapter10 = nn.Linear(4096, 4096)
        ...
        user_in_emb_path = "../data/" + world.dataset + "/yw_user_features_glm.pkl"
        ...
        user_embedding_tensor_0 = torch.stack(attention_outputs)  # (3508, 4096)
